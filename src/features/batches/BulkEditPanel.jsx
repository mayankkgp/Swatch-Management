...
export default function BulkEditPanel({
  ...
  const selectClass = "appearance-none w-full text-xs bg-slate-50 hover:bg-slate-100/70 focus:bg-white rounded border border-slate-200 focus:outline-hidden focus:border-slate-400 text-slate-800 transition-colors duration-150 font-sans cursor-pointer py-1 px-1 md:h-8 md:py-0 md:pl-2 md:pr-8 disabled:opacity-50 disabled:cursor-not-allowed";
  const inputClass = "w-full text-xs bg-slate-50 hover:bg-slate-100/70 focus:bg-white rounded border border-slate-200 focus:outline-hidden focus:border-slate-400 text-slate-800 transition-colors duration-150 font-sans py-1 px-1 md:h-8 md:py-0 md:px-2 disabled:opacity-50 disabled:cursor-not-allowed";
  const textareaClass = "w-full text-xs bg-slate-50 hover:bg-slate-100/70 focus:bg-white rounded border border-slate-200 focus:outline-hidden focus:border-slate-400 text-slate-800 transition-colors duration-150 font-sans py-1 px-1 md:px-2 md:py-1.5 resize-none overflow-y-auto min-h-8 disabled:opacity-50 disabled:cursor-not-allowed";
